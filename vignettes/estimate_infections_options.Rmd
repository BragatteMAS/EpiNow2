...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2282 (1369 -- 3685)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.72 -- 1.1)
#> 4:               Rate of growth -0.027 (-0.095 -- 0.038)
#> 5: Doubling/halving time (days)         -26 (18 -- -7.3)
# elapsed time (in seconds)
get_elapsed_time(def$fit)
#>         warmup sample
#> chain:1 23.138 31.543
#> chain:2 31.553 30.203
#> chain:3 32.606 18.934
#> chain:4 32.160 30.028
# summary plot
plot(def)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2275 (1396 -- 3739)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.72 -- 1.1)
#> 4:               Rate of growth -0.028 (-0.096 -- 0.039)
#> 5: Doubling/halving time (days)         -25 (18 -- -7.2)
# elapsed time (in seconds)
get_elapsed_time(agp$fit)
#>         warmup sample
#> chain:1 17.878 25.695
#> chain:2 22.288 32.443
#> chain:3 25.314 26.657
#> chain:4 19.661 32.832
# summary plot
plot(agp)
```
...
#>                         measure                estimate
#>                          <char>                  <char>
#> 1:       New infections per day     2287 (1378 -- 3723)
#> 2:   Expected change in reports       Likely decreasing
#> 3:   Effective reproduction no.       0.9 (0.72 -- 1.1)
#> 4:               Rate of growth -0.027 (-0.097 -- 0.04)
#> 5: Doubling/halving time (days)        -25 (17 -- -7.2)
# elapsed time (in seconds)
get_elapsed_time(dep$fit)
#>         warmup sample
#> chain:1 37.050 16.754
#> chain:2 31.441 29.993
#> chain:3 35.293 23.910
#> chain:4 30.518 18.712
# summary plot
plot(dep)
```
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day    4584 (2714 -- 8203)
#> 2:   Expected change in reports      Likely increasing
#> 3:   Effective reproduction no.      1.1 (0.91 -- 1.4)
#> 4:               Rate of growth 0.042 (-0.029 -- 0.13)
#> 5: Doubling/halving time (days)        16 (5.4 -- -24)
# elapsed time (in seconds)
get_elapsed_time(trunc$fit)
#>         warmup sample
#> chain:1 28.793 18.119
#> chain:2 28.221 20.913
#> chain:3 31.668 18.257
#> chain:4 25.153 20.415
# summary plot
plot(trunc)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2268 (1374 -- 3856)
#> 2:   Expected change in reports        Likely decreasing
#> 3:   Effective reproduction no.        0.9 (0.72 -- 1.1)
#> 4:               Rate of growth -0.028 (-0.096 -- 0.045)
#> 5: Doubling/halving time (days)         -25 (16 -- -7.2)
# elapsed time (in seconds)
get_elapsed_time(project_rt$fit)
#>         warmup sample
#> chain:1 35.841 32.596
#> chain:2 32.732 35.658
#> chain:3 37.077 33.628
#> chain:4 35.508 33.846
# summary plot
plot(project_rt)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2308 (1927 -- 2769)
...
#>                         measure               estimate
#>                          <char>                 <char>
#> 1:       New infections per day     2005 (998 -- 3982)
#> 2:   Expected change in reports      Likely decreasing
#> 3:   Effective reproduction no.     0.85 (0.61 -- 1.1)
#> 4:               Rate of growth -0.042 (-0.12 -- 0.04)
#> 5: Doubling/halving time (days)       -16 (17 -- -5.9)
# elapsed time (in seconds)
get_elapsed_time(rw$fit)
#>         warmup sample
#> chain:1  7.360  8.824
#> chain:2  9.003 15.363
#> chain:3 12.474 11.111
#> chain:4  8.627 15.182
# summary plot
plot(rw)
```
...
#>                         measure                 estimate
#>                          <char>                   <char>
#> 1:       New infections per day      2794 (2420 -- 3284)
#> 2:   Expected change in reports               Decreasing
#> 3:   Effective reproduction no.       0.89 (0.8 -- 0.97)
#> 4:               Rate of growth -0.031 (-0.063 -- 4e-04)
#> 5: Doubling/halving time (days)        -22 (1700 -- -11)
# elapsed time (in seconds)
get_elapsed_time(no_delay$fit)
#>         warmup sample
#> chain:1 36.547 30.307
#> chain:2 33.562 30.583
#> chain:3 36.104 41.310
#> chain:4 34.126 33.349
# summary plot
plot(no_delay)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2544 (2504 -- 2582)
#> 2:   Expected change in reports                Decreasing

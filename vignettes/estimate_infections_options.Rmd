...
#>         warmup sample
#> chain:1 27.314 27.021
#> chain:2 34.003 19.188
#> chain:3 32.783 24.941
#> chain:4 34.226 28.945
# summary plot
plot(def)
```
...
#>         warmup sample
#> chain:1 17.889 29.008
#> chain:2 19.833 28.588
#> chain:3 17.918 28.044
#> chain:4 20.649 18.159
# summary plot
plot(agp)
```
...
#>         warmup sample
#> chain:1 31.795 28.838
#> chain:2 27.272 20.543
#> chain:3 30.628 28.696
#> chain:4 24.390 33.176
# summary plot
plot(dep)
```
...
#>         warmup sample
#> chain:1 30.194 21.352
#> chain:2 30.375 25.157
#> chain:3 30.062 21.726
#> chain:4 32.417 24.034
# summary plot
plot(trunc)
```
...
#>         warmup sample
#> chain:1 37.872 33.716
#> chain:2 37.503 33.437
#> chain:3 34.165 32.048
#> chain:4 39.404 34.312
# summary plot
plot(project_rt)
```
...
#>         warmup sample
#> chain:1  7.318 15.666
#> chain:2  9.278 15.552
#> chain:3  7.313 16.175
#> chain:4  8.156 15.152
# summary plot
plot(rw)
```
...
#>         warmup sample
#> chain:1 31.831 30.843
#> chain:2 38.958 32.605
#> chain:3 31.245 35.994
#> chain:4 33.213 31.638
# summary plot
plot(no_delay)
```
...
#>                         measure                  estimate
#>                          <char>                    <char>
#> 1:       New infections per day       2544 (2503 -- 2582)
#> 2:   Expected change in reports                Decreasing

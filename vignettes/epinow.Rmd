...
#> '/tmp/RtmpcOcAmy/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to the console and:
#> '/tmp/RtmpcOcAmy/epinow/2020-04-21.log'.
#> WARN [2025-08-01 02:41:50] epinow: There were 3 divergent transitions after warmup. See
#> https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
#> to find out why this is a problem and how to eliminate them. - 
#> WARN [2025-08-01 02:41:50] epinow: Examine the pairs() plot to diagnose sampling problems
#>  -
res$plots$R
```
...
#> INFO [2025-08-01 02:41:53] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/RtmpcOcAmy/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/RtmpcOcAmy/epinow/2020-04-21.log'.
#> INFO [2025-08-01 02:41:53] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-08-01 02:41:53] No target directory specified so returning output
#> INFO [2025-08-01 02:41:53] Producing estimates for: testland, realland
#> INFO [2025-08-01 02:41:53] Regions excluded: none
#> INFO [2025-08-01 02:42:56] Completed estimates for: testland
#> INFO [2025-08-01 02:43:58] Completed estimates for: realland
#> INFO [2025-08-01 02:43:58] Completed regional estimates
#> INFO [2025-08-01 02:43:58] Regions with estimates: 2
#> INFO [2025-08-01 02:43:58] Regions with runtime errors: 0
#> INFO [2025-08-01 02:43:58] Producing summary
#> INFO [2025-08-01 02:43:58] No summary directory specified so returning summary output
#> INFO [2025-08-01 02:43:58] No target directory specified so returning timings
## summary
region_rt$summary$summarised_results$table
#>      Region New infections per day Expected change in reports
#>      <char>                 <char>                     <fctr>
#> 1: realland    2246 (1343 -- 3710)          Likely decreasing
#> 2: testland    2247 (1312 -- 3741)          Likely decreasing
#>    Effective reproduction no.         Rate of growth
#>                        <char>                 <char>
#> 1:          0.9 (0.72 -- 1.1) -0.03 (-0.098 -- 0.04)
#> 2:           0.9 (0.7 -- 1.1) -0.028 (-0.1 -- 0.039)
...
#> INFO [2025-08-01 02:43:58] Producing following optional outputs: regions, summary, samples, plots, latest
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2 logs to the console and:
#> '/tmp/RtmpcOcAmy/regional-epinow/2020-04-21.log'.
#> Logging threshold set at INFO for the name logger
#> Writing EpiNow2.epinow logs to: '/tmp/RtmpcOcAmy/epinow/2020-04-21.log'.
#> INFO [2025-08-01 02:43:59] Reporting estimates using data up to: 2020-04-21
#> INFO [2025-08-01 02:43:59] No target directory specified so returning output
#> INFO [2025-08-01 02:43:59] Producing estimates for: testland, realland
#> INFO [2025-08-01 02:43:59] Regions excluded: none
#> INFO [2025-08-01 02:45:06] Completed estimates for: testland
#> INFO [2025-08-01 02:45:35] Completed estimates for: realland
#> INFO [2025-08-01 02:45:35] Completed regional estimates
#> INFO [2025-08-01 02:45:35] Regions with estimates: 2
#> INFO [2025-08-01 02:45:35] Regions with runtime errors: 0
#> INFO [2025-08-01 02:45:35] Producing summary
#> INFO [2025-08-01 02:45:35] No summary directory specified so returning summary output
#> INFO [2025-08-01 02:45:35] No target directory specified so returning timings
## summary
region_separate_rt$summary$summarised_results$table
#>      Region New infections per day Expected change in reports
#>      <char>                 <char>                     <fctr>
#> 1: realland    1957 (1011 -- 3771)          Likely decreasing
#> 2: testland  2507 (1390 -- 107365)          Likely decreasing
#>    Effective reproduction no.          Rate of growth
#>                        <char>                  <char>
#> 1:         0.84 (0.59 -- 1.1) -0.044 (-0.11 -- 0.035)
#> 2:         0.92 (0.72 -- 2.4) -0.022 (-0.092 -- 0.23)
#>    Doubling/halving time (days)
#>                          <char>
#> 1:             -16 (20 -- -6.1)
#> 2:            -32 (3.1 -- -7.6)
